(() => {
  ...
  $('#helpButton').addEventListener('click', () => openGeneric('How to use this MVP', '<ol><li>Search for a name or select a report portrait to focus its family tree.</li><li>Follow parents and children, or switch to hive and list views.</li><li>Use the living-person switch to show or hide available profile details.</li><li>Use Add archive item to save a file, link, or note; collection details are optional.</li><li>Read source pages with Previous and Next, or open the original PDF.</li><li>Zoom the wall, tap a photograph and use the research notebook to link identities and supporting evidence.</li></ol><p>The collection stays in your private Site. Original PDFs are unredacted.</p>'));
