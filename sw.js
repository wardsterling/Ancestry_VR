...
const CACHE='living-wall-shell-v7';
const FILES=['./','index.html','styles.css','archive.css','archive-explorer.css','report-edition.css','archive-model.js','archive-privacy.js','source-viewer.js','profile-presentation.js','archive-explorer.js','app.js','search-engine.js','search-ui.js','data.js','manifest.webmanifest'];
...
self.addEventListener('fetch',event=>{
  ...
  if(/\/archive-(data|tree|private-details)\.json$|\/source-documents\/|\/assets\/report-portraits\//.test(url.pathname)){
