...
const CACHE='living-wall-shell-v8';
...
self.addEventListener('fetch',event=>{
  ...
  if(/\/api\/|\/wall-catalog\.json$|\/source-pages\/|\/archive-(data|tree|private-details)\.json$|\/source-documents\/|\/assets\/report-portraits\//.test(url.pathname)){
