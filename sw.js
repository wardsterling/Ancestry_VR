...
const CACHE='living-wall-shell-v15';
const FILES=['archive-session.js','photo-match-rules.js','photo-matcher.js','wall-matches.js','photo-augment-rules.js','photo-similarity.js','wall-identification.js','wall-identification.css','source-attributes.js','person-statistics.js','person-insights.js','person-insights.css','./','index.html','styles.css','archive.css','archive-explorer.css','report-edition.css','photo-workspace.css','photo-research.js','photo-workspace.js','archive-import.js','archive-items.js','archive-intake.js','archive-intake.css','archive-model.js','archive-privacy.js','source-viewer.js','profile-presentation.js','archive-explorer.js','app.js','search-engine.js','search-ui.js','data.js','manifest.webmanifest'];
...
self.addEventListener('fetch',event=>{
  ...
  if(/\/import-base\.json$|\/api\/|\/source-people\.json$|\/wall-catalog\.json$|\/source-pages\/|\/archive-(data|tree|private-details)\.json$|\/source-documents\/|\/assets\/report-portraits\//.test(url.pathname)){
